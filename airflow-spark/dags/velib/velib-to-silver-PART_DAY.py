...
def write_job_success_flag(**kwargs):
    ...
    s3_client = create_s3_client()
    write_object_to_minio(s3_client, "velib", f'_tech/flags/job_success_silver/{part_day_value}.success', "content")
...
dag = DAG(
        dag_id="spark-app-velib-to-silver-PART_DAY", 
        description="todo",
...
for part_day_value in part_day_values:
    spark_task = SparkSubmitOperator(
        ...
        application="/usr/local/spark/app/spark-app-velib-to-silver-PART_DAY.py",
        name=f"spark-app-velib-to-silver-PART_DAY={part_day_value}",
        ...
        env_vars={
            ...
            "TRINO_OUTPUT_SCHEMA": "velib_silver",
            "TRINO_OUTPUT_SCHEMA_LOCATION": "s3a://velib/silver/",
            "TRINO_OUTPUT_TABLE": "velib_disponibilite_en_temps_reel",
            "TRINO_OUTPUT_TABLE_LOCATION": "s3a://velib/silver/velib-disponibilite-en-temps-reel",
        },
        conf={
