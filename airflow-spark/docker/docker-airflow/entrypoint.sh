...
case "$1" in
  webserver)
    ...
    # Set spark_default connection to use spark://spark:7077
    airflow connections --delete --conn_id 'spark_default' || true
    airflow connections --add --conn_id 'spark_default' --conn_type 'spark' --conn_host 'spark://spark' --conn_port '7077'
